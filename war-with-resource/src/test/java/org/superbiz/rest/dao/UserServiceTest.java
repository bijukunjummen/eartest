...
public class UserServiceTest {
    ...
    public static void start() throws IOException {
        ...
        p.setProperty(EJBContainer.APP_NAME, "war-with-resource");
    ...
    public void create() throws NamingException {
        ...
        final String uri = "http://127.0.0.1:" + System.getProperty(EmbeddedTomEEContainer.TOMEE_EJBCONTAINER_HTTP_PORT) + "/war-with-resource";
